...
## 安装其他组件
```sh
sudo pacman -S waybar foot xdg-desktop-portal-wlr wlclipboard mako \
  networkmanager network-manager-applet wofi swaybg brightnessctl playerctl \
...
| **networkmanager** | 网络管理服务 | 控制系统网络连接，后台守护进程（systemd 服务）。 |
...
| **pipewire** | 音频与视频服务 | 替代 PulseAudio/Jack，提供高性能音频、视频处理支持。 |
| **wireplumber** | PipeWire 的会话管理器 | 管理 PipeWire 的设备与策略，确保音频功能正常运行。 |
